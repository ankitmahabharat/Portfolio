...
const Navbar = () => {
  ...
  return (
    <nav
      className={` fixed hrefp-5 left-0 w-full z-50 transition duration-300 px-[7vw] lg:px-[20vw] ${isScroll ? " bg-transparent bg-opacity-50 backdrop-blur-md" : "bg-transparent"}`}
    >
      ...
      {isOpen && (
        <div className=" absolute  hrefp-16 left-10 transform-translate-x-1/2 w-4/5  bg-[#11021d] bg-opacity-50 backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg">
